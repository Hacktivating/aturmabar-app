...
import {
  ...
  Calendar, Clock, Play, CheckCircle, Sparkles, Trash2
} from 'lucide-react';
                      ...
                      <div className="pt-4 border-t border-subtle dark:border-subtle-dark mt-6">
                        ...
                        <div className="flex flex-col gap-3">
                          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 p-4 rounded-xl border border-subtle dark:border-subtle-dark bg-app dark:bg-app-dark">
                            <div>
                              <p className="text-sm font-bold text-primary dark:text-primary-dark">{t('tour_walkthrough_title', 'Start App Walkthrough')}</p>
                              <p className="text-xs text-muted-ink dark:text-faint mt-1">{t('tour_walkthrough_desc', 'Take a guided tour to learn how to manage your community.')}</p>
                            </div>
                            <button 
                            ...
                            >
                              <Sparkles size={16} /> {t('start_tour', 'Start Tour')}
                            </button>
                          </div>
